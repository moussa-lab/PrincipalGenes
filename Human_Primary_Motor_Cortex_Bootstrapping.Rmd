---
title: "Human_Primary_Motor_Cortex_Bootstrapping"
output:
  html_document:
    toc: yes
    toc_float: yes
...
#Human_Primary_Motor_Cortex DATASET
##Read in the dataset
```{r read-data}

input_file<-paste0(here(), "/Filtered_Input/Human_Primary_Motor_Cortex.csv")
truth_file<-paste0(here(), "/Filtered_Input/Human_Primary_Motor_CortexLabels.csv")
name<-"Human_Primary_Motor_Cortex"
...
ggsave(filename = paste0(here(), "/Bootstrapping_Results/Human_Primary_Motor_Cortex_Results/Human_Primary_Motor_Cortex_PCA_Plot.jpg"),, 
    dpi = 300)
```
...
write.csv(plot_df1, file = paste0(here(), "/Bootstrapping_Data_Hold/Human_Primary_Motor_Cortex_PG_HVG_Union_CumulativeScore_Subsampled_Accuracy.csv"))
```
...
ggsave(filename = paste0(here(), "/Bootstrapping_Results/Human_Primary_Motor_Cortex_Results/Human_Primary_Motor_Cortex_PG_HVG_Union_CumulativeScore_Subsampled_Sensitivity.jpg"),, 
     dpi = 300)
```