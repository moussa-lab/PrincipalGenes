...
ggsave(filename = paste0(here(), "/Bootstrapping_Results/PBMC_Results/PBMC_PCA_Plot.jpg"),, 
    dpi = 300)
```
...
write.csv(plot_df1, file = paste0(here(), "/Bootstrapping_Data_Hold/PBMC_PG_HVG_Union_CumulativeScore_Subsampled_Accuracy.csv"))
```
...
ggsave(filename = paste0(here(), "/Bootstrapping_Results/PBMC_Results/PBMC_PG_HVG_Union_CumulativeScore_Subsampled_Sensitivity.jpg"),, 
     dpi = 300)
```