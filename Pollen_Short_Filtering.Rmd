...
write.csv(points_sk, file=paste0(here(), "/Data_Hold/Pollen_SKM_accuracy_results.csv"))
...
ggsave(filename = paste0(here(), "/results/Pollen_Results/Pollen_PG_HVG_UNION_Sensitivity.jpg"),, 
     dpi = 300)
...
write.csv(points_sk, file=paste0(here(), "/Data_Hold/Pollen_SKM_rand_index_results.csv"))
...
ggsave(filename = paste0(here(), "/results/Pollen_Results/Pollen_PG_HVG_UNION_RandIndex.jpg"),, 
     dpi = 300)
...
ggsave(filename = paste0(here(), "/results/Pollen_Results/Pollen_PG_HVG_UNION_No_Outliers_Sensitivity.jpg"),, 
     dpi = 300)
...
write.csv(intersect_df, file = paste0(here(), "/Data_Hold/Pollen_PPS_HVG_Variance_Mean_Intersect.csv"))
write.csv(raw_scores_df, file = paste0(here(), "/Data_Hold/Pollen_PPS_HVG_Variance_Mean_Top100.csv"))
```
