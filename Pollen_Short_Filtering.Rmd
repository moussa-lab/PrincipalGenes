...
input_file<-"/Pollen_smaller_count_matrix.csv"
truth_file<-"/Pollen_Labels.csv"
name<-"Pollen"
...
#get true labels
true_labels<-read.csv(paste0(here() , truth_file))
...
ggplot(PC1_and_PC2, aes(x=PC1, y=PC2, color=labels))+
  ...
  scale_color_brewer(palette="Set1",
                     name = "Label") +
  theme_minimal()+
  labs(x = "PC1", y = "PC2", title="Pollen PCA Plot")+
  theme(plot.title=element_text(hjust=0.5))
ggsave(filename = paste0(here(), "/Post_Log2_Norm/Filtered/Pollen_Results/Pollen_PCA_Plot.jpg"),, 
     dpi = 300)
```
...
##SK MEANS CLUSTERING USING UNION OF HVGS AND Pollen AT EACH POINT
```{r}
pg_hvg_union<-list()
...
write.csv(points_sk, file=paste0(here(), "/Post_Log2_Norm/Filtered/Pollen_Results/Short_Pollen_SKM_accuracy_results.csv"))
...
ggplot(plot_df1, aes(x = thresholds, y = sensitivity, color = metric)) +
  ...
  labs(x = "Cumulative Score",
       ...
       title = "SK-means Clustering Sensitivity for Pollen Dataset: Loess Regression") +
  scale_color_manual(
...
ggsave(filename = paste0(here(), "/Post_Log2_Norm/Filtered/Pollen_Results/Short_Pollen_PG_HVG_UNION_Sensitivity.jpg"),, 
     dpi = 300)
...
write.csv(points_sk, file=paste0(here(), "/Post_Log2_Norm/Filtered/Pollen_Results/Short_Pollen_SKM_rand_index_results.csv"))
...
ggplot(plot_df, aes(x = thresholds, y = adjustedRandIndex, color = metric)) +
  ...
  labs(x = "Cumulative Score",
       y = "RandIndex",
       color = "Gene Selection Method",
       title = "SK-means Rand Index for Pollen Dataset: Loess Regression") +
  scale_color_manual(
...
ggsave(filename = paste0(here(), "/Post_Log2_Norm/Filtered/Pollen_Results/Short_Pollen_PG_HVG_UNION_RandIndex.jpg"),, 
     dpi = 300)
...
ggplot(plot_df1_filtered, aes(x = thresholds, y = sensitivity, color = metric)) +
  ...
  labs(x = "Cumulative Score",
       y = "Clustering Sensitivity",
       color = "Gene Selection Method",
       title = "SK-means Clustering Sensitivity for Pollen Dataset: Loess Regression Outliers Removed") +
  scale_color_manual(
    breaks = c("PG_sensitivity","HVG_sensitivity","PG_HVG_Union"),
    values = c(
      "PG_sensitivity"  = "#1BB7D8",
...
ggsave(filename = paste0(here(), "/Post_Log2_Norm/Filtered/Pollen_Results/Short_Pollen_PG_HVG_UNION_No_Outliers_Sensitivity.jpg"),, 
     dpi = 300)
...
ggplot(plot_df_filtered, aes(x = thresholds, y = adjustedRandIndex, color = metric)) +
  ...
  labs(x = "Cumulative Score",
       y = "Rand Index",
       color = "Gene Selection Method",
       title = "SK-means Clustering Rand Index for Pollen Dataset: Loess Regression Outliers Removed") +
  scale_color_manual(
    breaks = c("PG_randIndex","HVG_randIndex","PG_HVG_UnionRand"),
    values = c(
      "PG_randIndex"  = "#1BB7D8",
...
write.csv(points_lv, file=paste0(here(), "/Post_Log2_Norm/Filtered/Pollen_Results/Short_Louvain_Pollen_lvM_accuracy_results.csv"))
...
ggplot(plot_df1, aes(x = thresholds, y = sensitivity, color = metric)) +
  ...
  geom_text(
    data = subset(plot_df1, metric == "PG_sensitivity"),
    aes(label = label_val),
    color = "#1BB7D8", vjust = +1, size = 3, check_overlap = TRUE
  ) +
  ...
  labs(x = "Cumulative Score",
       y = "Clustering Sensitivity",
       color = "Gene Selection Method",
       title = "Louvain Clustering Sensitivity for Pollen Dataset: Loess Regression") +
  scale_color_manual(
    breaks = c("PG_sensitivity","HVG_sensitivity","PG_HVG_Union"),
    values = c(
      "PG_sensitivity"  = "#1BB7D8",
...
ggsave(filename = paste0(here(), "/Post_Log2_Norm/Filtered/Pollen_Results/Short_Louvain_Pollen_PG_HVG_UNION_Sensitivity.jpg"),, 
        dpi = 300)
...
write.csv(points_lv, file=paste0(here(), "/Post_Log2_Norm/Filtered/Pollen_Results/Short_Louvain_Pollen_lvM_rand_index_results.csv"))
...
ggplot(plot_df, aes(x = thresholds, y = adjustedRandIndex, color = metric)) +
  ...
  labs(x = "Cumulative Score",
       y = "RandIndex",
       color = "Gene Selection Method",
       title = "Louvain Rand Index for Pollen Dataset: Loess Regression") +
  scale_color_manual(
    breaks = c("PG_randIndex","HVG_randIndex","PG_HVG_UnionRand"),
    values = c(
      "PG_randIndex"  = "#1BB7D8",
...
ggsave(filename = paste0(here(), "/Post_Log2_Norm/Filtered/Pollen_Results/Short_Louvain_Pollen_PG_HVG_UNION_RandIndex.jpg"),, 
        dpi = 300)
...
ggplot(plot_df1_filtered, aes(x = thresholds, y = sensitivity, color = metric)) +
  ...
  labs(x = "Cumulative Score",
       y = "Clustering Sensitivity",
       color = "Gene Selection Method",
       title = "Louvain Clustering Sensitivity for Pollen Dataset: Loess Regression Outliers Removed") +
  scale_color_manual(
    breaks = c("PG_sensitivity","HVG_sensitivity","PG_HVG_Union"),
    values = c(
      "PG_sensitivity"  = "#1BB7D8",
...
ggsave(filename = paste0(here(), "/Post_Log2_Norm/Filtered/Pollen_Results/Short_Louvain_Pollen_PG_HVG_UNION_No_Outliers_Sensitivity.jpg"),, 
        dpi = 300)
...
ggplot(plot_df_filtered, aes(x = thresholds, y = adjustedRandIndex, color = metric)) +
  ...
  labs(x = "Cumulative Score",
       y = "Rand Index",
       color = "Gene Selection Method",
       title = "Louvain Clustering Rand Index for Pollen Dataset: Loess Regression Outliers Removed") +
  scale_color_manual(
    breaks = c("PG_randIndex","HVG_randIndex","PG_HVG_UnionRand"),
    values = c(
      "PG_randIndex"  = "#1BB7D8",
...
write.csv(intersect_df, file = paste0(here(), "/Post_Log2_Norm/Filtered/Pollen_Results/Short_pollen_PPS_HVG_Variance_Mean_Intersect.csv"))
write.csv(raw_scores_df, file = paste0(here(), "/Post_Log2_Norm/Filtered/Pollen_Results/Short_pollen_PPS_HVG_Variance_Mean_Top100.csv"))
```
...
ggplot() +
  ...
  theme(plot.title = element_text(hjust = 0.5))
ggsave(filename = paste0(here(), "/Post_Log2_Norm/Filtered/Pollen_Results/Pollen_PS_Dispersion_Comparison.jpg"),, 
     dpi = 300)
...
ggplot() +
  ...
  labs(
    ...
    y = "log10 variance",
    title = "Pollen Top 20 genes: Log10 mean expression vs variance"
  ) +
  theme_minimal() +
  scale_color_manual(
    values = c(
...
ggsave(filename = paste0(here(), "/Post_Log2_Norm/Filtered/Pollen_Results/Pollen_PG_HVG_INTERSECT_Log10_mean_variance.jpg"),, 
     dpi = 300)
...
ggsave(filename = paste0(here(), "/Post_Log2_Norm/Filtered/Pollen_Results/Pollen_PG_Only_Violin_Plot.jpg"),, 
     dpi = 300)

VlnPlot(norm_seuratObject, features=hvg_only_gene_names[1:9]) & 
  theme(axis.title.x = element_blank(),
        axis.text.x = element_blank())
ggsave(filename = paste0(here(), "/Post_Log2_Norm/Filtered/Pollen_Results/Pollen_HVG_Only_Violin_Plot.jpg"),, 
     dpi = 300)

VlnPlot(norm_seuratObject, features=common_gene_names[1:9]) & 
  theme(axis.title.x = element_blank(),
        axis.text.x = element_blank())
ggsave(filename = paste0(here(), "/Post_Log2_Norm/Filtered/Pollen_Results/Pollen_PG_HVG_INTERSECT_Violin_Plot.jpg"),, 
    dpi = 300)
```
