---
title: "TabulaMuris_Lung_Sensitivity_ARI"
output:
  html_document:
    toc: yes
    toc_float: yes
...
input_file<-"/Filtered_Input/TabulaMuris_Lung_Counts.csv"
truth_file<-"/Filtered_Input/TabulaMuris_Lung_Labels.csv"
...
ggsave(filename = paste0(here(), "/Sensitivity_ARI_Results/TabulaMuris_Lung_Results/TabulaMuris_Lung_PCA_Plot.jpg"),, 
        dpi = 300)
```
...
write.csv(points_sk, file=paste0(here(), "/Main_Data_Hold/TabulaMuris_Lung_SKM_accuracy_results.csv"))
...
ggsave(filename = paste0(here(), "/Sensitivity_ARI_Results/TabulaMuris_Lung_Results/TabulaMuris_Lung_PG_HVG_UNION_Sensitivity.jpg"),, 
        dpi = 300)
...
write.csv(points_sk, file=paste0(here(), "/Main_Data_Hold/TabulaMuris_Lung_SKM_rand_index_results.csv"))
...
ggsave(filename = paste0(here(), "/Sensitivity_ARI_Results/TabulaMuris_Lung_Results/TabulaMuris_Lung_PG_HVG_UNION_RandIndex.jpg"),, 
        dpi = 300)
...
ggsave(filename = paste0(here(), "/Sensitivity_ARI_Results/TabulaMuris_Lung_Results/TabulaMuris_Lung_PG_HVG_UNION_No_Outliers_Sensitivity.jpg"),, 
        dpi = 300)
...
ggsave(filename = paste0(here(), "/Sensitivity_ARI_Results/TabulaMuris_Lung_Results/TabulaMuris_Lung_PG_HVG_UNION_No_Outliers_RandIndex.jpg"),, 
        dpi = 300)
...
write.csv(intersect_df, file = paste0(here(), "/Main_Data_Hold/TabulaMuris_Lung_PPS_HVG_Variance_Mean_Intersect.csv"))
write.csv(raw_scores_df, file = paste0(here(), "/Main_Data_Hold/TabulaMuris_Lung_PPS_HVG_Variance_Mean_Top100.csv"))
```
...
ggplot() +
  ...
  theme(plot.title = element_text(hjust = 0.5))
ggsave(filename = paste0(here(), "/Sensitivity_ARI_Results/TabulaMuris_Lung_Results/TabulaMuris_Lung_PS_Dispersion_Comparison.jpg"),, 
     dpi = 300)
...
ggsave(filename = paste0(here(), "/Sensitivity_ARI_Results/TabulaMuris_Lung_Results/TabulaMuris_Lung_PG_HVG_INTERSECT_Log10_mean_variance.jpg"),, 
        dpi = 300)
...
ggsave(filename = paste0(here(), "/Sensitivity_ARI_Results/TabulaMuris_Lung_Results/TabulaMuris_Lung_PG_Only_Violin_Plot.jpg"),, 
        dpi = 300)
...
VlnPlot(norm_seuratObject, features=hvg_only_gene_names[1:9]) & 
  theme(axis.title.x = element_blank(),
        ...
        axis.title.y = element_blank(),
        legend.position = "none")
ggsave(filename = paste0(here(), "/Sensitivity_ARI_Results/TabulaMuris_Lung_Results/TabulaMuris_Lung_HVG_Only_Violin_Plot.jpg"),, 
        dpi = 300)
...
VlnPlot(norm_seuratObject, features=common_gene_names[1:9]) & 
  theme(axis.title.x = element_blank(),
        ...
        axis.title.y = element_blank(),
        legend.position = "none")
ggsave(filename = paste0(here(), "/Sensitivity_ARI_Results/TabulaMuris_Lung_Results/TabulaMuris_Lung_PG_HVG_INTERSECT_Violin_Plot.jpg"),, 
        dpi = 300)
```