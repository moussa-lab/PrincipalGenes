---
title: "TabulaMuris_Lung_Bootstrapping"
output:
  html_document:
    toc: yes
    toc_float: yes
...
#TabulaMuris_Lung DATASET
##Read in the dataset
```{r read-data}

input_file<-paste0(here(), "/Filtered_Input/TabulaMuris_Lung_Counts.csv")
truth_file<-paste0(here(), "/Filtered_Input/TabulaMuris_Lung_Labels.csv")
name<-"Tabula_Muris_Lung"
...
ggsave(filename = paste0(here(), "/Bootstrapping_Results/TabulaMuris_Lung_Results/TabulaMuris_Lung_PCA_Plot.jpg"),, 
    dpi = 300)
```
...
write.csv(plot_df1, file = paste0(here(), "/Bootstrapping_Data_Hold/TabulaMuris_Lung_PG_HVG_Union_CumulativeScore_Subsampled_Accuracy.csv"))
```
...
ggsave(filename = paste0(here(), "/Bootstrapping_Results/TabulaMuris_Lung_Results/TabulaMuris_Lung_PG_HVG_Union_CumulativeScore_Subsampled_Sensitivity.jpg"),, 
     dpi = 300)
```