---
title: "TabulaMuris_Lung_Short_Filtering"
output:
  html_document:
    toc: yes
    toc_float: yes
...
input_file<-"/Tabula_Muris_Lung_smaller_count_matrix.csv"
truth_file<-"/Tabula_Muris_Lung_Labels.csv"
...
ggplot(PC1_and_PC2, aes(x=PC1, y=PC2, color=labels))+
  ...
  theme_minimal()+
  labs(x = "PC1", y = "PC2", title="TabulaMuris_Lung PCA Plot")+
  theme(plot.title=element_text(hjust=0.5))

ggsave(filename = paste0(here(), "/Post_Log2_Norm/Filtered/TabulaMuris_Lung_Results/TabulaMuris_Lung_PCA_Plot.jpg"),, 
        dpi = 300)
```
...
##SK MEANS CLUSTERING USING UNION OF HVGS AND TabulaMuris_LungS AT EACH POINT
```{r}
pg_hvg_union<-list()
...
write.csv(points_sk, file=paste0(here(), "/Post_Log2_Norm/Filtered/TabulaMuris_Lung_Results/Short_TabulaMuris_Lung_SKM_accuracy_results.csv"))
...
ggplot(plot_df1, aes(x = thresholds, y = sensitivity, color = metric)) +
  ...
  labs(x = "Cumulative Score",
       ...
       title = "SK-means Clustering Sensitivity for TabulaMuris_Lung Dataset: Loess Regression") +
  scale_color_manual(
...
ggsave(filename = paste0(here(), "/Post_Log2_Norm/Filtered/TabulaMuris_Lung_Results/Short_TabulaMuris_Lung_PG_HVG_UNION_Sensitivity.jpg"),, 
        dpi = 300)
...
write.csv(points_sk, file=paste0(here(), "/Post_Log2_Norm/Filtered/TabulaMuris_Lung_Results/Short_TabulaMuris_Lung_SKM_rand_index_results.csv"))
...
ggplot(plot_df, aes(x = thresholds, y = adjustedRandIndex, color = metric)) +
  ...
  labs(x = "Cumulative Score",
       y = "Rand Index",
       color = "Gene Selection Method",
       title = "SK-means Rand Index for TabulaMuris_Lung Dataset: Loess Regression") +
  scale_color_manual(
...
ggsave(filename = paste0(here(), "/Post_Log2_Norm/Filtered/TabulaMuris_Lung_Results/Short_TabulaMuris_Lung_PG_HVG_UNION_RandIndex.jpg"),, 
        dpi = 300)
...
ggplot(plot_df1_filtered, aes(x = thresholds, y = sensitivity, color = metric)) +
  ...
  labs(x = "Cumulative Score",
       y = "Clustering Sensitivity",
       color = "Gene Selection Method",
       title = "SK-means Clustering Sensitivity for TabulaMuris_Lung Dataset: Loess Regression Outliers Removed") +
  scale_color_manual(
    breaks = c("PG_sensitivity","HVG_sensitivity","PG_HVG_Union"),
    values = c(
      "PG_sensitivity"  = "#1BB7D8",
...
ggsave(filename = paste0(here(), "/Post_Log2_Norm/Filtered/TabulaMuris_Lung_Results/Short_TabulaMuris_Lung_PG_HVG_UNION_No_Outliers_Sensitivity.jpg"),, 
        dpi = 300)
...
ggplot(plot_df_filtered, aes(x = thresholds, y = adjustedRandIndex, color = metric)) +
  ...
  labs(x = "Cumulative Score",
       y = "Rand Index",
       color = "Gene Selection Method",
       title = "SK-means Clustering Rand Index for TabulaMuris_Lung Dataset: Loess Regression Outliers Removed") +
  scale_color_manual(
    breaks = c("PG_randIndex","HVG_randIndex","PG_HVG_UnionRand"),
    values = c(
      "PG_randIndex"  = "#1BB7D8",
...
ggsave(filename = paste0(here(), "/Post_Log2_Norm/Filtered/TabulaMuris_Lung_Results/Short_TabulaMuris_Lung_PG_HVG_UNION_No_Outliers_RandIndex.jpg"),, 
        dpi = 300)
...
write.csv(points_lv, file=paste0(here(), "/Post_Log2_Norm/Filtered/TabulaMuris_Lung_Results/Short_Louvain__TabulaMuris_Lung_lvM_accuracy_results.csv"))
...
ggplot(plot_df1, aes(x = thresholds, y = sensitivity, color = metric)) +
  ...
  labs(x = "Cumulative Score",
       y = "Clustering Sensitivity",
       color = "Gene Selection Method",
       title = "Louvain Clustering Sensitivity for TabulaMuris_Lung Dataset: Loess Regression") +
  scale_color_manual(
    breaks = c("PG_sensitivity","HVG_sensitivity","PG_HVG_Union"),
    values = c(
      "PG_sensitivity"  = "#1BB7D8",
...
ggsave(filename = paste0(here(), "/Post_Log2_Norm/Filtered/TabulaMuris_Lung_Results/Short_Louvain_TabulaMuris_Lung_PG_HVG_UNION_Sensitivity.jpg"),,
       dpi = 300)
...
write.csv(points_lv, file=paste0(here(), "/Post_Log2_Norm/Filtered/TabulaMuris_Lung_Results/Short_Louvain_TabulaMuris_Lung_lvM_rand_index_results.csv"))
...
ggplot(plot_df, aes(x = thresholds, y = adjustedRandIndex, color = metric)) +
  ...
  labs(x = "Cumulative Score",
       y = "Rand Index",
       color = "Gene Selection Method",
       title = "Louvain Rand Index for TabulaMuris_Lung Dataset: Loess Regression") +
  scale_color_manual(
    breaks = c("PG_randIndex","HVG_randIndex","PG_HVG_UnionRand"),
    values = c(
      "PG_randIndex"  = "#1BB7D8",
...
ggsave(filename = paste0(here(), "/Post_Log2_Norm/Filtered/TabulaMuris_Lung_Results/Short_Louvain_TabulaMuris_Lung_PG_HVG_UNION_RandIndex.jpg"),, 
        dpi = 300)
...
ggplot(plot_df1_filtered, aes(x = thresholds, y = sensitivity, color = metric)) +
  ...
  labs(x = "Cumulative Score",
       y = "Clustering Sensitivity",
       color = "Gene Selection Method",
       title = "Louvain Clustering Sensitivity for TabulaMuris_Lung Dataset: Loess Regression Outliers Removed") +
  scale_color_manual(
    breaks = c("PG_sensitivity","HVG_sensitivity","PG_HVG_Union"),
    values = c(
      "PG_sensitivity"  = "#1BB7D8",
...
ggsave(filename = paste0(here(), "/Post_Log2_Norm/Filtered/TabulaMuris_Lung_Results/Short_Louvain_TabulaMuris_Lung_PG_HVG_UNION_No_Outliers_Sensitivity.jpg"),, 
        dpi = 300)
...
ggplot(plot_df_filtered, aes(x = thresholds, y = adjustedRandIndex, color = metric)) +
  ...
  labs(x = "Cumulative Score",
       y = "Rand Index",
       color = "Gene Selection Method",
       title = "Louvain Clustering Rand Index for TabulaMuris_Lung Dataset: Loess Regression Outliers Removed") +
  scale_color_manual(
    breaks = c("PG_randIndex","HVG_randIndex","PG_HVG_UnionRand"),
    values = c(
      "PG_randIndex"  = "#1BB7D8",
...
ggsave(filename = paste0(here(), "/Post_Log2_Norm/Filtered/TabulaMuris_Lung_Results/Short_Louvain_TabulaMuris_Lung_PG_HVG_UNION_No_Outliers_RandIndex.jpg"),, 
        dpi = 300)
...
write.csv(intersect_df, file = paste0(here(), "/Post_Log2_Norm/Filtered/TabulaMuris_Lung_Results/TabulaMuris_Lung_PPS_HVG_Variance_Mean_Intersect.csv"))
write.csv(raw_scores_df, file = paste0(here(), "/Post_Log2_Norm/Filtered/TabulaMuris_Lung_Results/TabulaMuris_Lung_PPS_HVG_Variance_Mean_Top100.csv"))
```
...
ggplot() +
  ...
  labs(
    x = "Principal Score",
    y = "Dispersion",
    title = "TabulaMuris_Lung: Principal Score vs Dispersion — Top 20 highlighted by method"
  ) +
  theme_minimal() +
  scale_color_manual(
    values = c(
  ...
  theme(plot.title = element_text(hjust = 0.5))
ggsave(filename = paste0(here(), "/Post_Log2_Norm/Filtered/TabulaMuris_Lung_Results/TabulaMuris_Lung_PS_Dispersion_Comparison.jpg"),, 
     dpi = 300)
...
ggplot() +
  ...
  labs(
    ...
    y = "log10 variance",
    title = "TabulaMuris_Lung Top 20 genes: Log10 mean expression vs variance"
  ) +
  theme_minimal() +
  scale_color_manual(
    values = c(
...
ggsave(filename = paste0(here(), "/Post_Log2_Norm/Filtered/TabulaMuris_Lung_Results/TabulaMuris_Lung_PG_HVG_INTERSECT_Log10_mean_variance.jpg"),, 
        dpi = 300)
...
ggsave(filename = paste0(here(), "/Post_Log2_Norm/Filtered/TabulaMuris_Lung_Results/TabulaMuris_Lung_PG_Only_Violin_Plot.jpg"),, 
        dpi = 300)

VlnPlot(norm_seuratObject, features=hvg_only_gene_names[1:9]) & 
  theme(axis.title.x = element_blank(),
        axis.text.x = element_blank())
ggsave(filename = paste0(here(), "/Post_Log2_Norm/Filtered/TabulaMuris_Lung_Results/TabulaMuris_Lung_HVG_Only_Violin_Plot.jpg"),, 
        dpi = 300)

VlnPlot(norm_seuratObject, features=common_gene_names[1:9]) & 
  theme(axis.title.x = element_blank(),
        axis.text.x = element_blank())
ggsave(filename = paste0(here(), "/Post_Log2_Norm/Filtered/TabulaMuris_Lung_Results/TabulaMuris_Lung_PG_HVG_INTERSECT_Violin_Plot.jpg"),, 
        dpi = 300)
```