...
input_file<-paste0(here(), "/Filtered_Input/Pollen_TPM_Matrix.csv")
truth_file<-paste0(here(), "/Filtered_Input/Pollen_Labels.csv")
name<-"Pollen"
...
ggsave(filename = paste0(here(), "/Bootstrapping_Results/Pollen_Results/Pollen_PCA_Plot.jpg"),, 
    dpi = 300)
```
...
write.csv(plot_df1, file = paste0(here(), "/Bootstrapping_Data_Hold/Pollen_PG_HVG_Union_CumulativeScore_Subsampled_Accuracy.csv"))
```
...
ggsave(filename = paste0(here(), "/Bootstrapping_Results/Pollen_Results/Pollen_PG_HVG_Union_CumulativeScore_Subsampled_Sensitivity.jpg"),, 
     dpi = 300)
```