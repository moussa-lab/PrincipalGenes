...
ggsave(filename = paste0(here(), "/results/PBMC_RESULTS/PBMC_PCA_Plot.jpg"),, 
    dpi = 300)
```
...
write.csv(points_sk, file=paste0(here(), "/results/PBMC_RESULTS/Short_PBMC_SKM_accuracy_results.csv"))
...
ggplot(plot_df1, aes(x = thresholds, y = sensitivity, color = metric)) +
  ...
  theme_minimal()
ggsave(filename = paste0(here(), "/results/PBMC_RESULTS/Short_PBMC_PG_HVG_UNION_Sensitivity.jpg"),, 
   dpi = 300)
...
write.csv(points_sk, file=paste0(here(), "/results/PBMC_RESULTS/Short_PBMC_SKM_rand_index_results.csv"))
...
ggsave(filename = paste0(here(), "/results/PBMC_RESULTS/Short_PBMC_PG_HVG_UNION_RandIndex.jpg"),, 
dpi = 300)
...
ggsave(filename = paste0(here(), "/results/PBMC_RESULTS/Short_PBMC_PG_HVG_UNION_No_Outliers_Sensitivity.jpg"),, 
...
ggsave(filename = paste0(here(), "/results/PBMC_RESULTS/Short_PBMC_PG_HVG_UNION_No_Outliers_RandIndex.jpg"),, 
    dpi = 300)
...
write.csv(points_lv, file=paste0(here(), "/results/PBMC_RESULTS/Short_PBMC_Louvain_accuracy_results.csv"))
...
ggsave(filename = paste0(here(), "/results/PBMC_RESULTS/Short_Louvain_PBMC_PG_HVG_UNION_Sensitivity.jpg"),, 
...
write.csv(points_sk, file=paste0(here(), "/results/PBMC_RESULTS/Short_PBMC_Louvain_rand_index_results.csv"))
...
ggsave(filename = paste0(here(), "/results/PBMC_RESULTS/Short_Louvain_PBMC_PG_HVG_UNION_RandIndex.jpg"),, 
       dpi = 300)
...
ggsave(filename = paste0(here(), "/results/PBMC_RESULTS/Short_Louvain_PBMC_PG_HVG_UNION_No_Outliers_Sensitivity.jpg"),, 
        dpi = 300)
...
ggsave(filename = paste0(here(), "/results/PBMC_RESULTS/Short_Louvain_PBMC_PG_HVG_UNION_No_Outliers_RandIndex.jpg"),, 
        dpi = 300)
...
write.csv(intersect_df, file = paste0(here(), "/results/PBMC_RESULTS/Short_pbmc_PPS_HVG_Variance_Mean_Intersect.csv"))
write.csv(raw_scores_df, file = paste0(here(), "/results/PBMC_RESULTS/Short_pbmc_PPS_HVG_Variance_Mean_Top100.csv"))
```
...
ggplot() +
  ...
  theme(plot.title = element_text(hjust = 0.5))
ggsave(filename = paste0(here(), "/results/PBMC_RESULTS/PBMC_PS_Dispersion_Comparison.jpg"),, 
...
ggsave(filename = paste0(here(), "/results/PBMC_RESULTS/PBMC_PG_HVG_INTERSECT_Log10_mean_variance.jpg"),, 
     dpi = 300)
...
ggsave(filename = paste0(here(), "/results/PBMC_RESULTS/PBMC_PG_Only_Violin_Plot.jpg"),, 
     dpi = 300)

VlnPlot(norm_seuratObject, features=hvg_only_gene_names[1:9]) & 
  theme(axis.title.x = element_blank(),
        axis.text.x = element_blank())
ggsave(filename = paste0(here(), "/results/PBMC_RESULTS/PBMC_HVG_Only_Violin_Plot.jpg"),, 
     dpi = 300)

VlnPlot(norm_seuratObject, features=common_gene_names[1:9]) & 
  theme(axis.title.x = element_blank(),
        axis.text.x = element_blank())
ggsave(filename = paste0(here(), "/results/PBMC_RESULTS/PBMC_PG_HVG_INTERSECT_Violin_Plot.jpg"),, 
     dpi = 300)
```
