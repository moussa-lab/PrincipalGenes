...
write.csv(smaller_count_matrix, paste0(here(), "/Data_Hold/", name, "_top100PG_count_matrix.csv"))
```
...
write.csv(points_sk, file=paste0(here(), "/Data_Hold/PBMC_SKM_accuracy_results.csv"))
...
ggplot(plot_df1, aes(x = thresholds, y = sensitivity, color = metric)) +
  ...
  theme_minimal()
ggsave(filename = paste0(here(), "/results/PBMC_RESULTS/PBMC_PG_HVG_UNION_Sensitivity.jpg"),, 
   dpi = 300)
...
write.csv(points_sk, file=paste0(here(), "/Data_Hold/PBMC_SKM_rand_index_results.csv"))
...
ggsave(filename = paste0(here(), "/results/PBMC_RESULTS/PBMC_PG_HVG_UNION_RandIndex.jpg"),, 
dpi = 300)
...
ggsave(filename = paste0(here(), "/results/PBMC_RESULTS/PBMC_PG_HVG_UNION_No_Outliers_Sensitivity.jpg"),, 
...
ggsave(filename = paste0(here(), "/results/PBMC_RESULTS/PBMC_PG_HVG_UNION_No_Outliers_RandIndex.jpg"),, 
    dpi = 300)
...
write.csv(intersect_df, file = paste0(here(), "/Data_Hold/PBMC_PPS_HVG_Variance_Mean_Intersect.csv"))
write.csv(raw_scores_df, file = paste0(here(), "/Data_Hold/PBMC_PPS_HVG_Variance_Mean_Top100.csv"))
```
