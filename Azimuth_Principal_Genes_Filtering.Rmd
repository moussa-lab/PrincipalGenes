...
ggsave(filename = paste0(here(), "/results/Azimuth_Results/Short_Azimuth_PG_HVG_UNION_Sensitivity.jpg"),, 
     dpi = 300)
...
ggsave(filename = paste0(here(), "/results/Azimuth_Results/Short_Azimuth_PG_HVG_UNION_RandIndex.jpg"),, 
     dpi = 300)
...
write.csv(intersect_df, file = paste0(here(), "/results/Azimuth_Results/Azimuth_PPS_HVG_Variance_Mean_Intersect.csv"))
write.csv(raw_scores_df, file = paste0(here(), "/results/Azimuth_Results/Azimuth_PPS_HVG_Variance_Mean_Top100.csv"))
```
